        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right custom-breadcrumb">
              <li class="breadcrumb-item"><a href="/product-category"><i class="fa fa-arrow-left" aria-hidden="true"></i>  Back</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
              ...
              <div class="col-md-6">
               <div class="form-group">
                ...
                <input type="file" id="pcimg" onchange="Checkformat()" style=" background: #ececec;color: black;padding: 1em;">
              ...
              <center>
                  ...
                  <button type="button" class="btn yellowbtn" onclick="AddProdCat()" id="submitButton">Submit</button>
