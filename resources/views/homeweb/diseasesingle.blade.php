		...
		<div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
				<div class="product-box">
					<a href="{{ route('product.single',$product->prod_id) }}"><div class="prdct-img-box">
					...
					<div class="price-detail-dv">
						<div class="price-dv">
							...
							{{-- <h5 class="mb-0 product-price">{{$product->Unit->price}}</h5> --}}
						</div>
						<div class="btn-cart">
							<a href="{{ route('product.single',$product->prod_id) }}" class="add-to-cart primary-bg btn text-white">View Details</a>
						</div>
					</div>
				</div>
			</div>
