			...
			<div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
					<div class="disese-box">
						<a href="{{route('diseasecat',$diseasecategories->id)}}">
							<img class="disese-img" src="{{$diseasecategories->image}}" alt="">
							<h5 class="mb-0 disease-name">{{$diseasecategories->title_eng}}</h5>
						</a>
					</div>
				</div>
                @endforeach
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="trending-products-dv">
					...
					<a href="{{ route('trend.product') }}" class="view-all-btn-products primary-bg btn text-white">View all <i class="ri-arrow-right-s-line"></i></a>
				</div>
			</div>
            @foreach ($trendproducts as $trendprod)
             <div class="col-lg-3 col-md-4 col-sm-6 col-6">
				<div class="product-box">
					<a href="{{ route('prodcat.single',$trendprod->id) }}"><div class="prdct-img-box">
						<img class="product-image" src="{{asset($trendprod->image)}}" alt="">
					</div> </a>
					<div class="price-detail-dv">
						<div class="price-dv">
							<h5 class="mb-0 product-name">{{$trendprod->title_eng}}</h5>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="trending-products-dv">
					...
					<a href="{{ route('feat.product') }}" class="view-all-btn-products primary-bg btn text-white">View all <i class="ri-arrow-right-s-line"></i></a>
				</div>
			</div>
			@foreach ($featuredproducts as $featuredprod)
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
				<div class="product-box">
					<a href="{{ route('prodcat.single',$featuredprod->id) }}"><div class="prdct-img-box">
						<img class="product-image" src="{{asset($featuredprod->image)}}" alt="">
					</div></a>
					<div class="price-detail-dv">
						<div class="price-dv">
							<h5 class="mb-0 product-name">{{$featuredprod->title_eng}}</h5>
							{{-- <h5 class="mb-0 product-price">₹ 20,000</h5> --}}
						</div>
						<div class="btn-cart">
